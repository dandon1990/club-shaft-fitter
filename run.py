...
print(title_bottom)
print(Fore.YELLOW + " DEEDEE's fitting app is for golfers")
print(" looking to get fitted for what irons")
print(" they should use and shafts to go with")
print(" those irons. Let's get started!")
main()
